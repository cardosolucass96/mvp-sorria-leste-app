    ...
    <div className="space-y-6">
      ...
      {dados && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <StatCard icon="💵" label="Comissão de Venda" value={formatarMoeda(dados.totais.venda)} color="border-success-500" />
          <StatCard icon="🔧" label="Comissão de Execução" value={formatarMoeda(dados.totais.execucao)} color="border-info-500" />
