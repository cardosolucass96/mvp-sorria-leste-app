...
const variantClasses: Record<NonNullable<ButtonProps['variant']>, string> = {
  ...
  danger: 'bg-error-600 text-error-50 hover:bg-error-700 focus:ring-error-400',
  destructive: 'bg-error-600 text-error-50 hover:bg-error-700 focus:ring-error-400',
  success: 'bg-success-600 text-success-50 hover:bg-success-700 focus:ring-success-400',
